...
values('HV', N'Sự Kiện Hot')

insert into CategoryEvents(Id, Name)
values('BV', N'Sự Kiện Lớn')

insert into CategoryEvents(Id, Name)
values('NV', N'Sự Kiện Cũ')
...
(
	...
	'https://i.pinimg.com/564x/5a/03/c5/5a03c576acda44bdcca254ea7495f82b.jpg',
...
(
	...
	'https://i.pinimg.com/736x/07/4e/fc/074efc6eed1791ccf811e190d9cfb38c.jpg',
...
(
	...
	'https://i.pinimg.com/564x/93/36/97/933697358e82ba635268ff3236418526.jpg',
...
(
	...
	'https://i.pinimg.com/564x/b5/20/80/b52080a67fc1a7547032858c6afffb95.jpg',
...
(
	...
	'https://i.pinimg.com/564x/09/63/f3/0963f312cd9a4882835173633691f494.jpg',
...
(
	...
	'https://i.pinimg.com/564x/78/9f/02/789f02f3de782576611133813b5b8428.jpg',
...
(
	...
	'https://i.pinimg.com/564x/98/59/4a/98594aab25eaeba314f542861b6f7a4a.jpg',
	N'Là một trong những chuyên ngành mới tại Đại học FPT, Trí Tuệ Nhân Tạo (AI) thu hút sự quan tâm của không ít sinh viên đam mê công nghệ và mong muốn đón đầu xu thế 4.0.',
	N'Tháng 11 này, FPTU Career Fair 2021 sẽ trở lại và hứa hẹn mang tới nhiều cơ hội việc làm cực hấp dẫn ở các doanh nghiệp hàng đầu trong và ngoài nước cho sinh viên Đại học FPT. 
...
Values
('ID ne','Ten GV','Img Gv','desgv','dategv','qotegv','ITS01')

Insert into Lecturer
([Id],[Name],[Img],[Des],[CreatedDate],[Quotes],[SubjectId])
Values('IDD','Ten giang vien','hinh giang vien','des','ngay','quotes','ITS01')
